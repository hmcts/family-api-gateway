...
module "case-document-mgmt-api" {
  ...
  swagger_url   = "https://raw.githubusercontent.com/hmcts/reform-api-docs/master/docs/specs/case-get-document.json"
...
data "case_document_template_file" "document_policy_template" {
...
module "prl-case-document-policy" {
  ...
  api_policy_xml_content = data.case_document_template_file.document_policy_template.rendered
