...
import {
  ...
  to =  azurerm_api_management_api
  # Specify the resource ID to import from
  id = "/subscriptions/d025fece-ce99-4df2-b7a9-b649d3ff2060/resourceGroups/cft-demo-network-rg/providers/Microsoft.ApiManagement/service/cft-api-mgmt-demo/apis/case-api;rev=1"
}